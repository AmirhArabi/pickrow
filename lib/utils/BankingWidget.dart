      ...
      child: Container(
        ...
        child: Text(
          ...
          style: primaryTextStyle(
              color:
                  widget.isStroked ? Banking_Primary : Banking_blueLightColor,
              size: 18,
...
Widget bankingOption(var icon, var heading, Color color) {
  return Container(
    ...
    child: Row(
      ...
      children: <Widget>[
        const Icon(Icons.keyboard_arrow_left, color: Banking_TextColorSecondary),
        Row(
          children: [
          ...
          Row(
            ...
            children: [
              ...
              Text("شماره حساب",
                  textDirection: TextDirection.rtl,
                  textAlign: TextAlign.right,
                  style: secondaryTextStyle(size: 16,fontFamily: fontRegular2))
